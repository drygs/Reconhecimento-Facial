...
def capturar_fotos():
    ...
    pessoa = input("Nome da pessoa para guardar as fotos: ").replace(" ", "_")
    ...
    print("A capturar 250 fotos automaticamente!\n")

    total_fotos = 250
    intervalo = 10 / total_fotos  # 250 fotos em ~10 segundos
    contador = 1
